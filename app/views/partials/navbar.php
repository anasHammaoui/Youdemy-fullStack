            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex-1 max-w-2xl px-6">
                    <div class="relative">
                       ...
                       <input type="text" placeholder="Search for anything" name="search" class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:border-purple-500">
                       </form>
                ...
                <?php } elseif (isset($_SESSION["user_role"]) && $_SESSION["user_role"] === "admin") {?>
                    <div class="flex items-center space-x-4">
                    <a class="text-gray-600 hover:text-gray-900" href="admin">Dashboard</a>
                    <a class="text-gray-600 hover:text-gray-900" href="logout">Logout</a>
                </div>
              <?php  }
                ?>
