...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="mb-8">
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Insertion en masse de tags</h2>
                <form class="space-y-4" action="addTags" method="get">
                    <div>
                        <textarea 
                        name="tags"
                            rows="4" 
                            placeholder="Entrez vos tags séparés par des virgules (ex: javascript, python, web development)" 
                        ...
                        ></textarea>
                        <p class="mt-2 text-sm text-gray-500">Séparez les tags par des virgules</p>
                    </div>
                    <button 
                    name="addTags"
                        type="submit"
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900 mb-4">Tags actuels</h2>
